...
public class NioHttpPipeliningHandler extends ChannelDuplexHandler {
    ...
    public void write(final ChannelHandlerContext ctx, final Object msg, final ChannelPromise promise) {
        ...
        try {
            ...
            List<Tuple<HttpResponse, NettyListener>> readyResponses = aggregator.write(response, listener);
            success = true;
            for (Tuple<HttpResponse, NettyListener> responseToWrite : readyResponses) {

...
public class BatchBulkIT extends ESIntegTestCase {
     ...
     * doc values skipper enabled, synthetic source, doc-values-only seq_no. This exercises pooled
     * field instances for numeric, date, and keyword fields in the batch path.
     */

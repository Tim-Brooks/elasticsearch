 ...
 * through every doc. Exposes a non-throwing {@link #nextDoc()} so cursors need neither a
 * try/catch nor a per-call null/dense check.
 *
 * <p>Deliberately NOT a {@link DocIdSetIterator}: that base declares {@code nextDoc() throws
 * IOException} and would force implementing {@code advance}/{@code cost}.
 */

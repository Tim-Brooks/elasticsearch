 ...
 * {@link #type()} (an {@link org.elasticsearch.sourcebatch.SourceValueType} byte). Value accessors are pure reads
...
public interface ArrayReader {
    ...
    /** The {@link org.elasticsearch.sourcebatch.SourceValueType} byte of the current element. */
    byte type();

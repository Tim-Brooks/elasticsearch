...
public abstract class AbstractBytesReference implements BytesReference {
    ...
    public long getLong(int index) {
        return (long) (get(index) & 0xFF) << 56 | (long) (get(index + 1) & 0xFF) << 48 | (long) (get(index + 2) & 0xFF) << 40 | (long) (get(
            index + 3
        ) & 0xFF) << 32 | (long) (get(index + 4) & 0xFF) << 24 | (get(index + 5) & 0xFF) << 16 | (get(index + 6) & 0xFF) << 8 | get(
            index + 7
        ) & 0xFF;
    }
